...
<head>
    ...
    <title>Halaman Komentar | Web Gallery</title>
</head>
<body>
    ...
    <form action="tambah_komentar.php" method="post">
        <?php
            include "koneksi.php";
            $fotoid=$_GET['fotoid'];
            $sql=mysqli_query($con,"select * from foto where fotoid='$fotoid'");
    ...
    <table width="100%" border="1" cellpadding=5 cellspacing=0>
        ...
        <?php
            ...
            $sql=mysqli_query($con,"select * from komentarfoto,user where komentarfoto.userid=user.userid");
            while($data=mysqli_fetch_array($sql)){
