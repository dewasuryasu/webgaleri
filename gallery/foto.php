...
<head>
    ...
    <title>Halaman Foto | Web Gallery</title>
</head>
<body>
    <h1>Halaman Foto</h1>
    <p>Selamat Datang <b>Dewa Surya</b></p>
    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        <?php
            include "koneksi.php";
            $userid=$_SESSION['userid'];
            $sql=mysqli_query($con,"select * from foto,album where foto.userid='$userid' and foto.albumid=album.albumid");
            while($data=mysqli_fetch_array($sql)){
        ...
        ?>
            <tr>
                ...
                <?php
                    $fotoid=$data['fotoid'];
                    $sql2=mysqli_query($con, "select * from likefoto where fotoid='$fotoid'");
